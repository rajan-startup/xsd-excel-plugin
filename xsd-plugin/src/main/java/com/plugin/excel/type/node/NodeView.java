...
/**
 * 
 * It creates a snapshot view of Node so, parent node can contains child node's view to maintain relationship
 * between them.
 * 
 * 
 *  ie: <xsd:element name="US" type="USFoodCompliance" minOccurs="0" maxOccurs="unbounded">
 *  
 *  nodeReferenceName = USFoodCompliance
 *  nodeTagName = US
 *  minOccurs=0
 *  maxOccurs=unbounded
 *  
...
public class NodeView implements Serializable {
	...
	public String toString() {
		return "NodeView [type=" + type + ", nodeTagName=" + nodeTagName
				+ ", complexNodeTypeName=" + complexNodeTypeName
				+ ", minOccurs=" + minOccurs + ", maxOccurs=" + maxOccurs
				+ ", nodeId=" + nodeId + ", isLoaded=" + isLoaded + "]";
	}
	...
	public void setMpConditionalAttributes(
			Map<String, String> mpConditionalAttributes) {
